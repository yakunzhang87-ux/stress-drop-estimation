...
def download_data(Main_events,data_path,all_stations,resp_path,chan,data_center='IRIS',EGF_events=None,**paras):
    ...
    try:
        ...
        main('Main',Main_events,data_path,all_stations,data_center)
        download_repsonse(Main_events, resp_path, all_stations, data_center)
    except:
        traceback.print_exc()
